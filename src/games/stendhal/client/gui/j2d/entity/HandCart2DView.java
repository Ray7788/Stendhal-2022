...
import games.stendhal.client.entity.HandCart;

/**
 * The 2D view of a chest.
 */
class HandCart2DView extends StateEntity2DView<HandCart> {
	/*
	 * The closed state.
	 */
	...
	/**
	 * The hand cart model open value changed.
	 */
	...
	/**
	 * Whether the user requested to open this hand cart.
	 */
	...
	/**
	 * Create a 2D view of a handcart.
	 */
	public HandCart2DView() {
		openChanged = false;
		requestOpen = false;
	}
	 ...
	 */
	@Override
	protected void buildSprites(HandCart entity, final Map<Object, Sprite> map) {
	 ...
	 */
	@Override
	protected Object getState(HandCart entity) {
		if (entity.isOpen()) {
			return STATE_OPEN;
		} else {
			return STATE_CLOSED;
	...
	protected void buildActions(final List<String> list) {
		...
		HandCart handcart = entity;
		if (handcart != null && handcart.isOpen()) {
	...
	public void entityChanged(final Object property) {
		...
		if (property == HandCart.PROP_OPEN) {
